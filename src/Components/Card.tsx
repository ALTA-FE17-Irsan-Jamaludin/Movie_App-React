...
export class Card extends Component<dataFilm> {
  render() {
    ...
    return (
      <div className="flex flex-col h-[20rem] w-11/12 bg-primary opacity-95 mt-5">
        <img src={gambar} alt="" className="h-[50%]" />
        <div className="title text-center h-[17%] bg-green-500 overflow-y-auto">
          <h3 className="font-semibold drop-shadow-md px-3">{name}</h3>
        </div>
        <p className="text-sm mt-2 mb-2 text-center text-slate-400 h-[13%] ">{deskripsi}</p>
